...
class Countries {
  ...
  static List<String> get allowedCountryCodes => _allowedCountryCodes;
  static Map<String, dynamic> get countryMap => _countryMap;

  void setCountryList(List<Map<String, dynamic>> countryList) {
    countryList = _countryList;
    _allowedCountryCodes =
        _countryList.map((value) => value[PropertyName] as String).toList();
    _countryMap = Map.fromEntries(
      _countryList
          .map((value) => MapEntry(value[PropertyName] as String, value)),
    );
  }

  static List<String> _allowedCountryCodes =
      _countryList.map((value) => value[PropertyName] as String).toList();
  static Map<String, dynamic> _countryMap = Map.fromEntries(
    _countryList.map((value) => MapEntry(value[PropertyName] as String, value)),
  );
  ...
  static List<Map<String, dynamic>> _countryList = [
    ...
    },
    {
      ...
      "nameTranslations": {
        ...
        "ru": "Центральная Африканская Республика"
      }
    },
    {
      "num_code": "148",
    ...
    },
    {
      ...
      "nameTranslations": {
        ...
        "ru": "Херд и Макдональдские острова"
      }
    },
    {
      "num_code": "336",
    ...
    },
    {
      ...
      "nameTranslations": {
        ...
        "ru": "Южная Джорджия и Южная Сэндвич Острова"
      }
    },
    {
      "num_code": "728",
